...
#FUNCIONES DE PREPROCESSING PARA ANTES DEL SPLI
...
#FUCNOONES LUEGO DEL SPLIT PARA EVIATR DATA LEAKAGE
#def completar_transmision(datasert):
# def moda_color(dataset):
# def moda_camara(dataset):
# completar_kilometros()

################################################
#FEATURE ENGENEERINGGGGG
# def crear_features_autos(dataset, current_year=2026):
#     """
#     Crea variables nuevas relevantes para explicar el precio.

#     - Antiguedad: años de uso aproximados.
#     - Km_por_anio: intensidad de uso del vehículo.
#     - Log_Km: transformación logarítmica para reducir asimetría en kilómetros.
#     """
#     dataset = dataset.copy()

#     dataset["Antiguedad"] = current_year - dataset["Año"]

#     dataset["Km_por_anio"] = (
#         dataset["Kilómetros"] / (dataset["Antiguedad"] + 1)
#     )

#     dataset["Log_Km"] = np.log1p(dataset["Kilómetros"])
...
#def one_hot_encoding(train, validation):


#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

#############################3
#A PARTIR DE ACA BORRARIA ESTA FUNCION PORQUE LO SEPARAMOS EN ANTES Y DSP DEL SPLIT !!! 
